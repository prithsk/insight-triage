        ...
        <Reveal className="relative z-10 w-full max-w-md" direction="none">
          ...
          <div className="bg-kx-surface rounded-2xl border border-kx-border p-8">
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center py-6">
                <div className="w-16 h-16 rounded-full bg-kx-critical/10 flex items-center justify-center mb-4">
                  <Mail className="w-8 h-8 text-kx-critical" />
                </div>
                <p className="text-center text-kx-muted text-[15px]">
                  If an account exists for <strong className="text-kx-ink">{email}</strong>, you'll receive an email with instructions to reset your password.
                </p>
              </div>
            ) : (
            ...
            <div className="mt-6 flex justify-center">
              <Link
                to="/login"
                className="flex items-center gap-2 text-[14px] text-kx-muted hover:text-kx-ink transition-colors"
              >
