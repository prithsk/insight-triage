...
/** D1 — The original side-by-side, now with the viewer auto-expanding under the live list. */
export function HeroBAClassic() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 py-28 bg-kx-surface overflow-hidden">
      <div className="relative z-10 max-w-2xl mx-auto text-center mb-12">
        ...
        <p className="text-[18px] text-kx-muted leading-relaxed">
          FIFO worklists don't know which scan is urgent. Kroix does, and it opens the
          read for you before anyone goes looking.
        </p>
      </div>

      <div className="relative z-10 max-w-6xl mx-auto w-full grid lg:grid-cols-[0.85fr_auto_1.15fr] gap-6 lg:gap-8 items-start">
        {/* BEFORE */}
        <div className="rounded-xl border border-kx-border bg-white/60 p-5 opacity-80 lg:mt-16">
        ...
        <div className="flex lg:flex-col items-center justify-center gap-2 py-2 lg:mt-32">
